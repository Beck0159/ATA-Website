...
<body>
    ...
    <div class="container clearTop panel-index panel-default topUp">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <img class="img-responsive" src="img/tennisTeamAbout.jpg">
            </div>
            <div class="col-md-6">
        ...
        <div class="row clearTop">
            ...
            <div class="col-lg-12">
				...
				<div class="col-xs-4"><img style="margin-bottom:15px;" src="img/logo_tommy.jpg" class="sponsors img img-responsive img-square center"/></div>
      ...
      <div class="panel-footer center" style="min-height: 40px; padding:0px;" id="contact-footer">
		  ...
		  <div class="container">
            ...
            <form  id="contact-form" method="post">
				...
				<div class="col-sm-4">
					<div class="">
					<h4 class="white left-form">Address:</h4>
					<p class="white left-form">March Tennis Club<br>
						Kanata, Ontario, Canada<br>
						K2T 1E9</h4>
					<p class="white left-form">Telephone: 1-519-885-3920</p>
					<h4 class="white left-form">Mailing Address:</h4>
					<p class="white left-form">March Tennis Club<br>
						PO Box 65<br>
						Kanata, ON<br>
						K2T 1E9
